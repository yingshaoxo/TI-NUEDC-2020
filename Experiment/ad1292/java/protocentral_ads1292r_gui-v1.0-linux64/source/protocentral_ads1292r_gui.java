...
public class protocentral_ads1292r_gui extends PApplet {
  ...
  // Downloaded from Processing IDE Sketch->Import Library->Add Library->G4P
  ////////////////////////////////////////////////////////////////////////////////////////// Install
  //
  /////////////////////////////////////////////////////////////////////////////////////////
      ...
      case CESState_PktLen_Found:
            ...
            && (CES_Pkt_Pos_Counter < CES_CMDIF_PKT_OVERHEAD + CES_Pkt_Len + 1)) // Read Data
        {
          if (CES_Pkt_PktType == 2) {
            CES_Pkt_Data_Counter[CES_Data_Counter++] = (char) (rxch); // Buffer that assigns the data separated from the
                                                                      // packet
          }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "protocentral_ads1292r_gui" };
    if (passedArgs != null) {
